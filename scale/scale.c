...
int scale_bilinear_16bit(uint16_t *dst, int dst_width, int dst_height, uint16_t *src, int src_width, int src_height)
{
    int i, j, k, r, s, ret;
    float x, y, x_adj, y_adj;
    int x_int, y_int, src_x, src_y;
...
int scale_bilinear_32bit(uint32_t *dst, int dst_width, int dst_height, uint32_t *src, int src_width, int src_height)
{
    int i, j, k, r, s, ret;
    float x, y, x_adj, y_adj;
    int x_int, y_int, src_x, src_y;
...
int scale_bilinear(uint8_t **dst, int dst_width, int dst_height, uint8_t *src, int src_width, int src_height, int sample_bits)
{
    int i, j, k, r, s, ret;
    float x, y, x_adj, y_adj;
    int x_int, y_int, src_x, src_y;
    ...
    if (sample_bits == 8) {
        *dst = (uint8_t*)malloc(dst_width * dst_height * 3);
        ...
        scale_bilinear_16bit(dst_bit16, dst_width, dst_height, src_bit16, src_width, src_height);
        ...
        scale_bilinear_32bit(dst_bit32, dst_width, dst_height, src_bit32, src_width, src_height);
...
int scale_bicubic_16bit(uint16_t *dst, int dst_width, int dst_height, uint16_t *src, int src_width, int src_height)
{
    int i, j, k, r, s, ret;
    float x, y, x_adj, y_adj;
    int x_int, y_int, src_x, src_y;
...
int scale_bicubic_32bit(uint32_t *dst, int dst_width, int dst_height, uint32_t *src, int src_width, int src_height)
{
    int i, j, k, r, s, ret;
    float x, y, x_adj, y_adj;
    int x_int, y_int, src_x, src_y;
...
int scale_bicubic(uint8_t **dst, int dst_width, int dst_height, uint8_t *src, int src_width, int src_height, int sample_bits)
{
    int i, j, k, r, s, ret;
    float x, y, x_adj, y_adj;
    int x_int, y_int, src_x, src_y;
    ...
    if (sample_bits == 8) {
        *dst = (uint8_t*)malloc(dst_width * dst_height * 3);
        ...
        dst_bit16 = (uint16_t*)malloc(dst_width * dst_height * 3 * sizeof(uint16_t));
        scale_bicubic_16bit(dst_bit16, dst_width, dst_height, src_bit16, src_width, src_height);
        ...
        dst_bit32 = (uint32_t*)malloc(dst_width * dst_height * 3 * sizeof(uint32_t));
        scale_bicubic_32bit(dst_bit32, dst_width, dst_height, src_bit32, src_width, src_height);
...
int scale(uint8_t **dst, int dst_width, int dst_height, uint8_t *src, int src_width, int src_height, int sample_bits, int calculator)
{
    ...
    if (calculator == 0) {
        scale_bilinear(dst, dst_width, dst_height, src, src_width, src_height, sample_bits);
    } else if (calculator == 1) {
        scale_bicubic(dst, dst_width, dst_height, src, src_width, src_height, sample_bits);
    }
